...
export default function WidgetConfigPanel({ isOpen, widget, onClose, onSave }) {
  ...
  const [type, setType] = useState("Scattered Chart");
  ...
  useEffect(() => {
    if (widget) {
      ...
      setType(widget.type || "Scattered Chart");
      setWidth(widget.width || 5);
      setHeight(widget.height || 5);
      setDescription(widget.description || "");
      setX_axis(widget.xAxis || "");
      setY_axis(widget.yAxis || "");
    }
  }, [widget]);
